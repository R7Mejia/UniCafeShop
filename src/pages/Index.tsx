...
// Import the image
import heroImage from "./imagenes/UniCafe.png"; // Adjust the path as needed
...
const Index = () => {
  return (
    <div className="pb-20">
      ...
      {/* Hero Section */}
      <div className="relative h-[40vh] sm:h-[60vh] md:h-[80vh]">
        ...
        <div className="relative z-20 h-full flex flex-col justify-center px-6">
          <div className="animate-fade-in">
            <h1 className="text-4xl sm:text-3xl md:text-5xl font-bold text-white mb-2">
              UniCafe
            </h1>
            <p className="text-coffee-cream text-lg sm:text-md md:text-xl mb-6">
      ...
      <div className="py-10 px-6 bg-coffee-cream">
        <h2 className="text-2xl sm:text-xl md:text-2xl font-bold text-coffee-dark text-center mb-8">
          Why Choose UniCafe?
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-coffee-dark/80">
              Expertly selected and roasted beans
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-coffee-dark/80">
              Supporting coffee farmers worldwide
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-10 px-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl sm:text-xl md:text-2xl font-bold text-coffee-dark">
            Featured Coffee
          </h2>
          <Link
            to="/shop"
            className="text-coffee-accent flex items-center text-sm">
      ...
      <div className="py-10 px-6 bg-coffee-dark text-white">
        <h2 className="text-2xl sm:text-xl md:text-2xl font-bold text-center mb-8">
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-coffee-dark/50 p-6 rounded-lg mb-6 border border-coffee-medium">
            ...
            <p className="mb-4 italic">
              "The Ethiopian Yirgacheffe has completely changed my morning
              routine. The fruity notes and smooth finish are unmatched!"
            </p>
      ...
      <div className="py-10 px-6 bg-coffee-cream">
        <div className="max-w-md mx-auto text-center">
          <h2 className="text-xl sm:text-lg md:text-xl font-bold text-coffee-dark mb-2">
            Join Our Coffee Club
          </h2>
          <p className="text-coffee-medium mb-4">
            Get updates, special offers and brewing tips
          </p>
